    ...
    <Title name={t('carPark')}/>
      <CardGroup>
        <Card style={{ width: "18rem" }} className='text-center'>
          <img src={truckCard} alt="" width='70px' height='70px' className="truckCard" />
          <Card.Body>
        ...
        <Card style={{ width: "18rem" }} className='text-center'>
        <img src={truckCard2} alt="" width='70px' height='70px' className="truckCard" />
          <Card.Body>
        ...
        <Card style={{ width: "18rem" }} className='text-center'>
        <img src={truckCard3} alt="" width='70px' height='70px' className="truckCard" />
          <Card.Body>
        ...
        <Card style={{ width: "18rem" }} className='text-center'>
        <img src={truckCard4} alt="" width='70px' height='70px' className="truckCard" />
          <Card.Body>
